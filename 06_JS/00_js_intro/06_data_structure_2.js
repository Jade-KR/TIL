...
// 1. forEach는 주어진 callback을 각 요소에 대해 오름차운으로 한번씩 실행
...
// some
// 배열 내의 어떤 요소라도(===하나라도) 주어진 함수를 통과하는지 테스트하고 결과에 따라 boolean을 return
const arr = [1, 2, 3, 4, 5]
