...
npm init (npm 은 pip와 비슷함 [ node package manage ])

npm install vue ( node에서 vue를 사용할 때 설치 )

npm i webpack webpack-cli -D ( node modules 생성)



touch webpack.config.js (webpack 관련 설정)
