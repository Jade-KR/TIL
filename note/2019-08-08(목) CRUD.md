...
**templates에 edit.html 파일 생성 후, new.html 파일 코드 복사 하고 붙여넣기**

**input은 value라는 속성에 변수치환 작성, textarea는 >사이에 작성<** 
...
{% block body %}
    ...
    <form action="/articles/{{ article.pk }}/update/" method="POST">
        ...
        <label for="content">Content</label><br>
        <textarea name="content" id="title" cols="30" rows="10">{{ article.content }}</textarea><br>
        <input type="submit" value="글쓰기">
    </form>
{% endblock %}
```
